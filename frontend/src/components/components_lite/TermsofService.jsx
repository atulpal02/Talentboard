...
const TermsOfService = () => {
  return (
    <div>
      ...
      <p>
       Welcome to JOB PORTAL. These Terms and Conditions govern your use of our website located at https://www.linkedin.com/in/atulpal02/
. By accessing or using our website, you agree to comply with these terms.
      ...
      <p>
       All content, trademarks, and other intellectual property on the website are owned by or licensed to atulpal02. You may not reproduce, distribute, or create derivative works from any content without our express written permission.
      </p>

      <h2>6. Limitation of Liability</h2>
      <p>
        To the fullest extent permitted by law, TalentBoard shall not be liable for any direct, indirect, incidental, special, consequential, or punitive damages arising from your use of the website. We do not guarantee that the website will be error-free or uninterrupted.
      </p>
      ...
      <p>
       If you have any questions about these Terms and Conditions, please contact us at: Email: atul07pal@gmail.com
      </p>
    </div>
  );
};
